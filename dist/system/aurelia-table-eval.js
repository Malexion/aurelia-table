...
System.register(['aurelia-framework', 'iterate-js'], function (_export, _context) {
    ...
    var bindable, bindingMode, computedFrom, __, _dec, _dec2, _dec3, _desc, _value, _class, _descriptor, _descriptor2, _descriptor3, AureliaTableEval;
    ...
    return {
        ...
        execute: function () {
            _export('AureliaTableEval', AureliaTableEval = (_dec = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec2 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec3 = bindable({ defaultBindingMode: bindingMode.twoWay }), (_class = function AureliaTableEval() {
                ...
                self.process = __.debounce(function () {
                    if (self.evaluate) {
                        self._evaluate = self.evaluate;
            ...
            _export('AureliaTableEval', AureliaTableEval);
        }
    };
});