...
System.register(['aurelia-framework', 'aurelia-templating-resources', 'iterate-js'], function (_export, _context) {
	...
	return {
		...
		execute: function () {
			...
			_export('AureliaTable', AureliaTable = (_dec = inject(BindingEngine, BindingSignaler), _dec2 = bindable(), _dec3 = bindable(), _dec4 = bindable(), _dec5 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec6 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec7 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec8 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec9 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec10 = computedFrom('rows', 'body', 'body.scrollHeight', 'body.clientHeight'), _dec11 = computedFrom('height'), _dec(_class = (_class2 = function () {
				function AureliaTable(bindings, signaler) {
					...
					self.sort = __.debounce(function () {
