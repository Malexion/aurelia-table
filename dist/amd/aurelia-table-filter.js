define(['exports', 'aurelia-framework', 'iterate-js'], function (exports, _aureliaFramework, _iterateJs) {
    ...
    exports.AureliaTableFilter = undefined;
    ...
    var AureliaTableFilter = exports.AureliaTableFilter = (_dec = (0, _aureliaFramework.bindable)(), _dec2 = (0, _aureliaFramework.bindable)(), _dec3 = (0, _aureliaFramework.bindable)({ defaultBindingMode: _aureliaFramework.bindingMode.twoWay }), (_class = function () {
        ...
        AureliaTableFilter.prototype.set = function set(path, value) {
            _iterateJs2.default.prop(this, path, value);
        };

        AureliaTableFilter.prototype.get = function get(path) {
            return _iterateJs2.default.prop(this, path);
        };
